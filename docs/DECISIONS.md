...
host platform owns those. This is a byline, not a product name, so it does not undo 0042.

**Choice.**
- A text mark, "By Berit", in the heading font, semibold, at meta size, in the primary text
  colour.
